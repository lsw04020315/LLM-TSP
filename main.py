...
parser.add_argument('--model_id', type=str, required=True, default='TSP-QBO-96-96')
parser.add_argument('--checkpoints', type=str, default='./checkpoints/')

parser.add_argument('--root_path', type=str, default='./dataset/QBO/')
parser.add_argument('--data_path', type=str, default='QBO-Singapore (48698)(0.50.751)N104E-six points-10-20-30-50-70-100 pressure1.csv')
...
parser.add_argument('--c_out', type=int, default=9)
...
for ii in range(args.itr):
    ...
    print("------------------------------------")
    mse, mae = test(model, test_data, setting, test_loader, args, device, ii)
    mses.append(mse)
    maes.append(mae)
